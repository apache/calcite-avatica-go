...
func TestHSQLDBContext(t *testing.T) {
...
func TestHSQLDBMultipleResultSets(t *testing.T) {
...
func TestHSQLDBColumnTypes(t *testing.T) {
	...
	runTests(t, dsn, func(dbt *DBTest) {
		...
		expectedColumnNames := []string{"INT", "BINT", "TINT", "SINT", "DBL", "DEC", "DEC2", "BOOL", "TM", "DT", "TMSTMP", "VAR", "CH", "BIN", "VARBIN"}
